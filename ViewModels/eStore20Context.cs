...
namespace Buoi21_Identity.ViewModels
{
    public partial class eStore20Context : DbContext
    {
        ...
        public virtual DbSet<VChiTietHoaDon> VChiTietHoaDon { get; set; }
        public virtual DbSet<VHangHoa> VHangHoa { get; set; }
...
//                optionsBuilder.UseSqlServer("Data Source=DESKTOP-7KQC0UG\\NAMPC;Initial Catalog=eStore20;Integrated Security=True");
            }
        }
