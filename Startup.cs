...
namespace Buoi15_ASP_Dapper
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var chuoiKetNoi = Configuration.GetConnectionString("Data1");


            //Khi sử dụng interface trong net core để thêm các phương thức ta phải addTransient cái interface mà chúng ta tạo
            services.AddTransient<ILoaiService, ILoaiDapper>();
